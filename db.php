...
$categories = [
    "fish" => new Category('<i class="fa-solid fa-fish"></i> fish'),
    "dog" => new Category('<i class="fa-solid fa-dog"></i> dog'),
    "bird" => new Category('<i class="fa-solid fa-dove"></i> bird'),
...
$products = [ 
    ...
    new Accessories("Wood", 1, "Voliera wilma in legno", "Wilma", 184.99, "https://arcaplanet.vtexassets.com/arquivos/ids/258384/voliera-wilma1.jpg", $categories["bird"]),
